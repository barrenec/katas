...
http://www.codewars.com/kata/56b7f2f3f18876033f000307/train/python
...
in_asc_order([9,8,7,6,5,4,3,2,1]) #
returns False because the numbers are in DESCENDING order
Extra Challenge: If time, try to optimise and shorten
